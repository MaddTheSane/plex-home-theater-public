...
cd $DEPENDDIR
./bootstrap
./configure --with-sdk=10.9 --with-rootpath=$ROOT/plex/Dependencies/xbmc-depends --with-toolchain=/Users/Shared/xbmc-depends/toolchain --with-darwin=$darwin --with-arch=$arch
make || exit 1
